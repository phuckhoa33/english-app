...
import Style from "./AskForLevelUpTest.module.scss";
...
function AskForLevelUpTest(props) {
        ...
        <div className={cx("buying-popup-container")}>
          ...
          <div className={cx("content-container", "p-5")}>
            ...
            <div className={cx("buying-popup-desc", "my-3")}>
              Bạn phải làm 1 bài kiểm tra để vượt tiến độ học
            </div>
            <div className="row pt-5">
              ...
              <div className="col justify-content-center align-items-center d-flex">
                <button
                  ...
                  onClick={() => navigate(`/readQuestionPage/levelUp/normal`)}
                >
                  Chấp nhận
                </button>
              </div>
...
export default AskForLevelUpTest;